...
package alluxio.underfs.alluxio.acl;

import alluxio.collections.Pair;
import alluxio.security.authorization.AccessControlList;
import alluxio.security.authorization.AclAction;
import alluxio.security.authorization.DefaultAccessControlList;
import alluxio.underfs.alluxio.AlluxioAclProvider;
 ...
 */
@ThreadSafe
public class SupportedAlluxioAclProvider implements AlluxioAclProvider {
  private static final Logger LOG = LoggerFactory.getLogger(SupportedAlluxioAclProvider.class);
  ...
  private AclEntry getAlluxioAclEntry(alluxio.security.authorization.AclEntry entry)
    ...
    builder.setType(getAlluxioAclEntryType(entry));
   ...
   */
  private AclEntryType getAlluxioAclEntryType(alluxio.security.authorization.AclEntry aclEntry)
      throws IOException {
