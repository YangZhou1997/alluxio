...
/**
 * Output stream implementation for {@link AlluxioUnderFileSystem}. This class is just a wrapper on top
 ...
 */
@NotThreadSafe
public class AlluxioUnderFileOutputStream extends OutputStream {
   ...
   */
  public AlluxioUnderFileOutputStream(FSDataOutputStream out) {
    mOut = out;
  }
