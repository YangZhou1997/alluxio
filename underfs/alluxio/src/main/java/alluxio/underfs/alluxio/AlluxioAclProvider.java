 ...
 */
public interface AlluxioAclProvider {
  /**
   ...
   */
  @Nullable
  Pair<AccessControlList, DefaultAccessControlList> getAcl(AbstractFileSystem hdfs, String path)
      throws IOException;
   ...
   */
  void setAclEntries(AbstractFileSystem hdfs, String path, List<AclEntry> aclEntries) throws IOException;
}
