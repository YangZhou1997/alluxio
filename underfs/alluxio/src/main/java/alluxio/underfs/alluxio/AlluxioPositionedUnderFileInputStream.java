 ...
 */
public class AlluxioPositionedUnderFileInputStream extends SeekableUnderFileInputStream {
  private long mPos;

  AlluxioPositionedUnderFileInputStream(FSDataInputStream in, long pos) {
    super(in);
    mPos = pos;
  }
