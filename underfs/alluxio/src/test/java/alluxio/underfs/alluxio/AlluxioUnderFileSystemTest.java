...
/**
 * Tests {@link AlluxioUnderFileSystem}.
 */
public final class AlluxioUnderFileSystemTest {

  private AlluxioUnderFileSystem mAlluxioUnderFileSystem;
  ...
  public final void before() throws Exception {
    ...
    mAlluxioUnderFileSystem = AlluxioUnderFileSystem.createInstance(new AlluxioURI("file:///"),
        conf);
  }

  /**
   * Tests the {@link AlluxioUnderFileSystem#getUnderFSType()} method. Confirm the UnderFSType for
   * AlluxioUnderFileSystem.
   */
  @Test
  public void getUnderFSType() throws Exception {
    Assert.assertEquals("hdfs", mAlluxioUnderFileSystem.getUnderFSType());
  }

  /**
   * Tests the {@link AlluxioUnderFileSystem#createConfiguration} method.
   *
  ...
  public void prepareConfiguration() throws Exception {
    UnderFileSystemConfiguration ufsConf =
        UnderFileSystemConfiguration.defaults(ConfigurationTestUtils.defaults());
    org.apache.hadoop.conf.Configuration conf = AlluxioUnderFileSystem.createConfiguration(ufsConf);
